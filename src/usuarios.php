        ...
        if (empty($id)) {
            ...
            if (empty($clave)) {
                ...
                if ($result > 0) {
                    ...
                    $query_insert = mysqli_query($conexion, "INSERT INTO usuario(rfc, nombre, Apaterno, aMaterno, fecha_nacimiento, sexo, telefono, correo, sueldo, direccion, usuario, clave, idrol, fecha_contratacion) VALUES ('$rfc', '$nombre', '$Apaterno', '$Am', '$fechaN', '$sexo', '$telefono', '$email', '$sueldo', '$direccion', '$user', '$clave', 1, CURRENT_TIMESTAMP)");
                    if ($query_insert) {
...
<div class="card">
    ...
    <div class="table-responsive">
        <table class="table table-hover table-striped table-bordered mt-2" id="tbl">
            ...
            <tbody>
            <?php
            $query = mysqli_query($conexion, "SELECT * FROM usuario where idrol=1");
